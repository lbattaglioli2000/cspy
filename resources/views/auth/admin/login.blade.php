                    ...
                    <div class="card shadow zindex-100">
                        <div class="card-body px-md-5 py-5">
                            <div class="text-center mb-5">
                                ...
                                <p class="text-muted mb-0">Sign in to your <b>admin account</b> to continue</p>
                            </div>
                            ...
                            <form role="form" method="post" action="{{ route('admin.login') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-transparent">
                                        ...
                                        <input type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" placeholder="name@codegeek.org">
                                        @if ($errors->has('email'))
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group input-group-transparent">
                                        ...
                                        <input type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" id="input-password" placeholder="Password">
