        ...
        @endif
            ...
            <div class="form-group">
                <div class="alert alert-info">
                    You are creating a new <b>challenge</b> for <b>unit {{ $lessonUnit }}</b>. Please select, from the drop down menu below, what lesson you want to associate this recap with.
